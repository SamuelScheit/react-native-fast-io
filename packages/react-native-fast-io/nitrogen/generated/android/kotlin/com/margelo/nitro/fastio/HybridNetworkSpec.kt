...
/**
 * A Kotlin class representing the Network HybridObject.
 * Implement this abstract class to create Kotlin-based instances of Network.
 */
@DoNotStrip
@Keep
...
abstract class HybridNetworkSpec: HybridObject() {
  ...
  companion object {
    private const val TAG = "HybridNetworkSpec"
    init {
      try {
