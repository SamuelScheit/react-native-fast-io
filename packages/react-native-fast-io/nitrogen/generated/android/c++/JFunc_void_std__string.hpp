...
namespace margelo::nitro::fastio {
  ...
  public:
    void call(jni::alias_ref<jni::JString> message) {
      return _func(message->toStdString());
    }

  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/fastio/Func_void_std__string;";
    static void registerNatives() {
      registerHybrid({makeNativeMethod("call", JFunc_void_std__string::call)});
    }

  private:
    explicit JFunc_void_std__string(const std::function<void(const std::string& /* message */)>& func): _func(func) { }
