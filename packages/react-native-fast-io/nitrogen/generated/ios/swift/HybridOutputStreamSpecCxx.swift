///
/// HybridOutputStreamSpecCxx.swift
...
/**
 * Helper class for converting instances of `HybridOutputStreamSpecCxx` from- and to unsafe pointers.
 ...
 */
public final class HybridOutputStreamSpecCxxUnsafe {
  /**
   * Casts a `HybridOutputStreamSpecCxx` instance to a retained unsafe raw pointer.
   * This acquires one additional strong reference on the object!
   */
  public static func toUnsafe(_ instance: HybridOutputStreamSpecCxx) -> UnsafeMutableRawPointer {
    return Unmanaged.passRetained(instance).toOpaque()
  }

  /**
   * Casts an unsafe pointer to a `HybridOutputStreamSpecCxx`.
   * The pointer has to be a retained opaque `Unmanaged<HybridOutputStreamSpecCxx>`.
   * This removes one strong reference from the object!
   */
  public static func fromUnsafe(_ pointer: UnsafeMutableRawPointer) -> HybridOutputStreamSpecCxx {
    return Unmanaged<HybridOutputStreamSpecCxx>.fromOpaque(pointer).takeRetainedValue()
  }
}
 ...
 */
public class HybridOutputStreamSpecCxx {
  /**
  ...
  /**
   * Create a new `HybridOutputStreamSpecCxx` that wraps the given `HybridOutputStreamSpec`.
   * All properties and methods bridge to C++ types.
   */
  public init(_ implementation: some HybridOutputStreamSpec) {
  ...
  // Methods
  @inline(__always)
  public func write(buffer: ArrayBufferHolder) -> bridge.std__shared_ptr_Promise_void__ {
    do {
