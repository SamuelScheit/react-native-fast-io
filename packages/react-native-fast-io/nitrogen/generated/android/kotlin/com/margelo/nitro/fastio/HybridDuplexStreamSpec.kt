...
/**
 * A Kotlin class representing the DuplexStream HybridObject.
 * Implement this abstract class to create Kotlin-based instances of DuplexStream.
 */
@DoNotStrip
@Keep
@Suppress("RedundantSuppression", "KotlinJniMissingFunction", "PropertyName", "RedundantUnitReturnType", "unused")
abstract class HybridDuplexStreamSpec: HybridObject() {
  @DoNotStrip
  ...
  @set:DoNotStrip
  @set:Keep
  abstract var inputStream: HybridInputStreamSpec
  
  @get:DoNotStrip
  @get:Keep
  @set:DoNotStrip
  @set:Keep
  abstract var outputStream: HybridOutputStreamSpec
  ...
  companion object {
    private const val TAG = "HybridDuplexStreamSpec"
    init {
      try {
