...
namespace margelo::nitro::fastio::bridge::swift {
   ...
   */
  using std__shared_ptr_Promise_Response__ = std::shared_ptr<Promise<Response>>;
  inline std::shared_ptr<Promise<Response>> create_std__shared_ptr_Promise_Response__() {
    return Promise<Response>::create();
  }
  inline PromiseHolder<Response> wrap_std__shared_ptr_Promise_Response__(std::shared_ptr<Promise<Response>> promise) {
    return PromiseHolder<Response>(std::move(promise));
  }
  
  // pragma MARK: std::function<void(const Response& /* result */)>
  /**
   * Specialized version of `std::function<void(const Response&)>`.
   */
  using Func_void_Response = std::function<void(const Response& /* result */)>;
  /**
   * Wrapper class for a `std::function<void(const Response& / * result * /)>`, this can be used from Swift.
   */
  class Func_void_Response_Wrapper final {
  public:
    explicit Func_void_Response_Wrapper(std::function<void(const Response& /* result */)>&& func): _function(std::make_shared<std::function<void(const Response& /* result */)>>(std::move(func))) {}
    inline void call(Response result) const {
      _function->operator()(result);
    }
  private:
    std::shared_ptr<std::function<void(const Response& /* result */)>> _function;
  };
  Func_void_Response create_Func_void_Response(void* _Nonnull swiftClosureWrapper);
  inline Func_void_Response_Wrapper wrap_Func_void_Response(Func_void_Response value) {
    return Func_void_Response_Wrapper(std::move(value));
  }
  ...
  // pragma MARK: Result<std::shared_ptr<Promise<Response>>>
  using Result_std__shared_ptr_Promise_Response___ = Result<std::shared_ptr<Promise<Response>>>;
  inline Result_std__shared_ptr_Promise_Response___ create_Result_std__shared_ptr_Promise_Response___(const std::shared_ptr<Promise<Response>>& value) {
    return Result<std::shared_ptr<Promise<Response>>>::withValue(value);
  }
  inline Result_std__shared_ptr_Promise_Response___ create_Result_std__shared_ptr_Promise_Response___(const std::exception_ptr& error) {
    return Result<std::shared_ptr<Promise<Response>>>::withError(error);
  }
